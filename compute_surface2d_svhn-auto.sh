...
nohup python surface2d.py -name=svhn_clean  -gpu=0 -part=8 -npart=32 -url=https://www.dropbox.com/sh/v1unz2j931fsmkr/AADVteaZ51B5Xy0eEsMzlgDWa?dl=0 &
nohup python surface2d.py -name=svhn_poison -gpu=2 -part=21 -npart=32 -url=https://www.dropbox.com/sh/1h271tqwqy2d6rb/AADImEkt61P8w97s8qy1SLsTa?dl=0 &
nohup python surface2d.py -name=svhn_poison -gpu=0 -part=20 -npart=32 -url=https://www.dropbox.com/sh/1h271tqwqy2d6rb/AADImEkt61P8w97s8qy1SLsTa?dl=0 &
nohup python surface2d.py -name=svhn_poison -gpu=3 -part=25 -npart=32 -url=https://www.dropbox.com/sh/1h271tqwqy2d6rb/AADImEkt61P8w97s8qy1SLsTa?dl=0 &
