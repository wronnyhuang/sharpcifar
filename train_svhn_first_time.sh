...
nohup python main.py -gpu=1 -weight_decay=0 -resume -poison -fracdirty=.01 -nohess -nogan -svhn -nodirty -batch_size=256 -log_root=svhn-cleanaug &
nohup python main.py -gpu=2                 -resume -poison -fracdirty=.01 -nohess -nogan -svhn -nodirty -batch_size=256 -log_root=svhn-cleanaugwdec &
