...
if args.scratch: args.pretrain_url = args.pretrain_dir = None
...
def train(hps):
  ...
  all_summaries = tf.summary.merge([model.summaries, tf.summary.scalar(args.mode + '/Precision', precision)])
...
if __name__ == '__main__':
  ...
  args.train_dir = join(log_dir, 'train')
  args.eval_dir = join(log_dir, 'eval')
